package com.febs.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://193.112.65.205:3306/febs?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "febs";
    // 数据库密码
    private static final String PASSWORD = "febs@123";
    // @author 值
    private static final String AUTHOR = "fsrong";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.febs";
    // xml文件路径
